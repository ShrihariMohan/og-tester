(async function (event) {
  ...
  try {
    const isTitleThere = document.getElementsByTagName('title') 
    const title = isTitleThere.length ? isTitleThere[0].innerText : "No Title"
    ...
    console.log("🔥 ~ ogTagsValues:", ogTagsValues)
    ...
    console.log("🔥 ~ ogTagsKeys:", ogTagsKeys)
